...
The performance table is empty by default. Click **Add performance** to add performances to the table one at a time. Clicking the cross ![Icon: cross](../img/icon_x.png){width="25"} will delete the row from the table.
