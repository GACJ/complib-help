...
![PPE 5-Spliced QP](../img/calling_layout_annotated_spliced.png)
...
![Grandsire Triples by leads, annotated](../img/calling_layout_byleads_annotated.png){width="400"}
...
![PPE 5-Spliced QP, by leads (partial)](../img/calling_layout_byleads_spliced_annotated.png){width="400"}
