...
## User Subscriptions
This section indicates which (if any) email notifications your account is subscribed to. Your user preferences for certain Complib functions are also listed here. Your user subscriptions and preferences can be changed by [editing your profile](#editing-your-profile).
...
Extended searches
:   The total number of [extended searches](../search/extended_search.md) you have performed while logged in to this account.

Private methods
:   The number of methods in the **Private** library which you created using this account. Acts as a link to a [method search](../search/method_search.md) which lists them all.
